<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DatosPagar.aspx.cs" Inherits="Vista.Forms.Pagar" %>
...
&nbsp;<asp:RequiredFieldValidator ID="rfvCP" runat="server" ControlToValidate="txtCP" ValidationGroup="Group1">*</asp:RequiredFieldValidator>
            ...
            <table class="auto-style2">
                <tr>
                    ...
                    <td class="auto-style5">&nbsp;&nbsp;&nbsp;
                        <asp:DropDownList ID="ddlPais" runat="server" ValidationGroup="Group1">
                        </asp:DropDownList>
&nbsp;<asp:RequiredFieldValidator ID="rfvProvincia" runat="server" ControlToValidate="ddlPais" ValidationGroup="Group1">*</asp:RequiredFieldValidator>
                    </td>
                    <td class="auto-style5">&nbsp;</td>
                </tr>
            </table>
...
&nbsp;<asp:RequiredFieldValidator ID="rfvLocalidad" runat="server" ControlToValidate="ddlLocalidad" ValidationGroup="Group1">*</asp:RequiredFieldValidator>
                    </td>
                    <td class="auto-style5">&nbsp;</td>
                </tr>
            </table>
...
&nbsp;</td>
            ...
            <asp:Button ID="btnContinuar" runat="server" Text="Continuar" ValidationGroup="Group1" />
        </div>
    </form>
</body>
</html>
